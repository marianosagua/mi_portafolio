    ...
    <div className="aboutMe" id="aboutMe" ref={ref}>
      ...
      >
        <p>
          ...
          sass, javascript, react js, redux, react native, android studio,
          firebase, me gusta mucho y me siento muy comodo trabajando en este
          ...
          ejercer cualquier trabajo referido a esto, siempre estoy abierto a
      ...
      <section className="aboutMe__profile">
        ...
        <a
          href="https://drive.google.com/file/d/1NnG-tHaQQYMce8yy-fJYMYdk6Pb2R8S1/view?usp=sharing"
